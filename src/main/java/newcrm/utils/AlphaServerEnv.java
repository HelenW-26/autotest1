...
import vantagecrm.DBUtils.DBConn;
	...
	public static List<String> getMT4TestServerIdByBrand(GlobalProperties.BRAND brand) {
		switch(brand){
			...
			case PUG:
				return Arrays.asList("400");
			case STAR:
//				return Arrays.asList("1050", "800");
				return Arrays.asList("810");
			case VJP:
				return Arrays.asList("400");
			case UM:
				return Arrays.asList("400");
