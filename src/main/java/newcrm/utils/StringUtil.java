...
/**
 * copy from dev, change lang to lang3
 * 
 * 
 */
public class StringUtil extends StringUtils {
    ...
    /**
     * check whether a string can be a password
     * a password should have 8-32 characters, at least 1 capital letter, 1 number and 1 lower case letter.
     * @param password
     * @return
     */
    public static boolean isValidPassword(String password) {
    	if (null==password || password.length()<8 || password.length()>32) {
    		return false;
    	}    	
    ...
    public static boolean isChinese(char c) {
        return Character.UnicodeScript.HAN.equals(Character.UnicodeScript.of(c));
    }
    ...
    public static void main(String[] args) {
    	//for testing
		String testString1 = "C3333333c12333";
		String testString2 = "123333333333";
		String testString3 = "cccccccccccccccccc";
		String testString4 = "CCCCCCCCCCCCC";
		System.out.println(isValidPassword(testString1));
		System.out.println(isValidPassword(testString2));
		System.out.println(isValidPassword(testString3));
		System.out.println(isValidPassword(testString4));
