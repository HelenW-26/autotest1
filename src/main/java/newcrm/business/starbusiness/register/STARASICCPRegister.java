...
import newcrm.pages.starclientpages.*;
...
public class STARASICCPRegister extends CPRegister {

    protected STARASICFinancialDetailsPage asic_fdpage;

    public STARASICCPRegister(WebDriver driver, String url) {
        super(driver, url);
        asic_fdpage = new STARASICFinancialDetailsPage(driver);
    }
    ...
    protected void setUpPDpage() {
        this.pdpage = new STARASICPersonalDetailsPage(driver);
    }

    @Override
    protected void setUpAddresspage() {
        addresspage = new STARASICResidentialAddressPage(driver);
    }

    @Override
    protected void setUpFDpage() {
        fdpage = new STARASICFinancialDetailsPage(driver);
    }
    ...
    protected void setUpQuizPage() {
        quizpage = new STARASICQuizPage(driver);
    }
...
//        menu.changeLanguage("English");
    ...
    public void fillFinacialPage() {
        ...
        userdetails.put("Experience with Financial Products", asic_fdpage.setFinancialProductsExp());
        userdetails.put("Income Source and Stability", asic_fdpage.setIncomeSourceStability());
        userdetails.put("Monthly Income", asic_fdpage.setMonthlyIncome());
        userdetails.put("Essential Monthly Expenses", asic_fdpage.setEssentialMonthlyExpenses());
        ...
        userdetails.put("Investment Amount Context", asic_fdpage.setInvestmentAmountContext());
        userdetails.put("Loss Impact Assessment", asic_fdpage.setLossImpactAssessment());
        userdetails.put("Source of Investment Funds", asic_fdpage.setSourceOfInvestmentFunds());
        userdetails.put("Financial Circumstances", asic_fdpage.setFinancialCircumstances());
        userdetails.put("Personal Circumstances", asic_fdpage.setPersonalCircumstances());
    }
    ...
    public void fillQuizPage() {
        ...
        quizpage.next();
        userdetails.put("Hedging Strategy Purpose", quizpage.setHedgingStrategyPurpose());
        quizpage.next();
        userdetails.put("Margin Purpose", quizpage.setMarginPurpose());
        quizpage.next();
        userdetails.put("Leverage Benefits", quizpage.setLeverageBenefit());
        quizpage.next();
        userdetails.put("Short Position", quizpage.setShortPosition());
        quizpage.next();
        userdetails.put("Ongoing Cost", quizpage.setOngoingCost());
        quizpage.next();
        userdetails.put("Order Type", quizpage.setOrderType());
        quizpage.next();
        userdetails.put("Negative Beta", quizpage.setNegativeBeta());
        quizpage.next();
