...
public class CPKoreaBankWithdraw extends CPLocalBankWithdraw {

	public CPKoreaBankWithdraw(WebDriver driver) {
		super(driver);
	}

	public CPKoreaBankWithdraw(LocalBankWithdrawPage v_page) {
		super(v_page);
	}
