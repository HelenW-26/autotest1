...
public class CPMalaysiaBankWithdraw extends CPLocalBankWithdraw {

	public CPMalaysiaBankWithdraw(WebDriver driver) {
		super(driver);
	}

	public CPMalaysiaBankWithdraw(LocalBankWithdrawPage v_page) {
		super(v_page);
	}
