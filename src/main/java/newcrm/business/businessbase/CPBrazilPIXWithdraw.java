...
public class CPBrazilPIXWithdraw extends CPLocalBankWithdraw {
	
	public CPBrazilPIXWithdraw(WebDriver driver) {
		super(driver);
	}

	public CPBrazilPIXWithdraw(LocalBankWithdrawPage v_page) {
		super(v_page);
	}
