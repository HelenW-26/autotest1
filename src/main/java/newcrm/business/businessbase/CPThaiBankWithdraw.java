...
public class CPThaiBankWithdraw extends CPLocalBankWithdraw {
	
	public CPThaiBankWithdraw(WebDriver driver) {
		super(driver);
	}

	public CPThaiBankWithdraw(LocalBankWithdrawPage v_page) {
		super(v_page);
	}
