...
public class CPMexicoBankWithdraw extends CPLocalBankWithdraw {
	
	public CPMexicoBankWithdraw(WebDriver driver) {
		super(driver);
	}

	public CPMexicoBankWithdraw(LocalBankWithdrawPage v_page) {
		super(v_page);
	}
