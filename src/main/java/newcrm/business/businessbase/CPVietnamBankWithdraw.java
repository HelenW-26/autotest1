...
public class CPVietnamBankWithdraw extends CPLocalBankWithdraw {

    public CPVietnamBankWithdraw(WebDriver driver) {
        super(driver);
    }

    public CPVietnamBankWithdraw(LocalBankWithdrawPage v_page) {
        super(v_page);
    }
