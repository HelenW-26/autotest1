...
public class IBAccountFCATestCases extends RegisterTestcases {
...
//            myfactor = getFactorNew();
    ...
    public void testIBReferralLinkVerificationFCA() throws Exception {
        if(brand.equalsIgnoreCase(BRAND.VFX.toString())) {
            ...
            cpMenu.goToMenu(CPMenuName.IBDASHBOARD);
    ...
    public void funcIBReferralLinkVerification() throws Exception {
        ...
        cpMenu.goToMenu(CPMenuName.IBREFERRALLINKSMENU);
    ...
    public void funcIBReferralLinkRegistration() throws Exception {
        ...
        String name = ibDemoAccount.registerIBDemoAccount(TraderURL,"United Kingdom");
        driver.close();
        driver.switchTo().window(originalHandle);
        //Verify Demo Account Dropped Under IB
        cpMenu.goToMenu(CPMenuName.IBACCOUNTREPORT);
//        ibAccountReport.verifyDemoAccountInAccountReport_Name(name);
        ...
        // Capture ss
        ScreenshotHelper.takeFullPageScreenshot(getDriverNew(), "screenshots", "checkFCADemoAccountRegistrationIsUnderIB");
        ...
        if(testEnv.equalsIgnoreCase("alpha")){
            ...
            // Capture ss
            ScreenshotHelper.takeFullPageScreenshot(getDriverNew(), "screenshots", "checkFCAH5DemoAccountRegistrationIsUnderIB");
        }
...
//        verifyNewTradingAccountIsUnderIBDownline_HomePage(ibAcc, newLiveAcc);
        ...
        // Capture ss
        ScreenshotHelper.takeFullPageScreenshot(getDriverNew(), "screenshots", "checkFCATradingAccountRegistrationIsUnderIB");
    }
    ...
    public String registerNewCPThroughIB(String affId, String campaignID, Boolean check) throws Exception {
        ...
        HashMap<String,String> userDetails = registerNew_WithoutCheckURL(affId, "", campaignID, PLATFORM.MT5, "", false, ACCOUNTTYPE.valueOf("STANDARD_STP"), CURRENCY.USD);
        clientEmail = email;
        clientPwd = pwd;
        clientName = userDetails.get("First Name");
...
//        cpMenu.closeAccQuizDialogPopup();
        ...
        cpMenu.goToMenu(CPMenuName.CPPORTAL);
        cpMenu.goToMenu(CPMenuName.LIVEACCOUNTS);
        cpMenu.goToMenu(CPMenuName.CPPORTAL);
        ...
        return cpLiveAccounts.getAccounts(PLATFORM.MT5).get(0).getAccountNum();
    }
...
//        }
    ...
    public void auditIBAccount(String email) throws InterruptedException {
        ...
        adminAccountAudit.auditIBAccount(email, BRAND.valueOf(BaseTestCaseNew.Brand.toUpperCase()));
    }
    ...
    public void auditAdditionalAccountIB(String email) {
        ...
        adminAdditionalAccountAudit.auditAdditionalAccountIB(email, BRAND.valueOf(BaseTestCaseNew.Brand.toUpperCase()));
    }
    ...
    public void auditTradingAccount(String email) throws InterruptedException {
        ...
        adminAccountAudit.auditTradingAccount(email, BRAND.valueOf(BaseTestCaseNew.Brand.toUpperCase()));
    }
}
