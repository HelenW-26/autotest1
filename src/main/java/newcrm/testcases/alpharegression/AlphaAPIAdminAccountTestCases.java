...
public class AlphaAPIAdminAccountTestCases extends AdminAccountTestCases {
	...
	public void initEnv(String brand, String server, ITestContext context) {
		...
		adminAcctAPI = new AdminAPIUserAccount((String) data[0][4], GlobalProperties.REGULATOR.valueOf((String)data[0][0]),(String)data[0][7],(String)data[0][8],GlobalProperties.BRAND.valueOf(brand.toUpperCase()), GlobalProperties.ENV.valueOf("ALPHA"));
	}
