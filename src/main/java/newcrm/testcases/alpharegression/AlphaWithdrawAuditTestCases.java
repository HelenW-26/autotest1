...
public class AlphaWithdrawAuditTestCases extends SystemSettingTestCases {
	...
	public void initiEnv(String brand,String server, ITestContext context) throws Exception {
		...
		AdminAPIPayment adminPaymentAPI = new AdminAPIPayment((String) adminData[0][4],
				GlobalProperties.REGULATOR.valueOf((String)adminData[0][0]),(String)adminData[0][7],
				(String)adminData[0][8],GlobalProperties.BRAND.valueOf(brand.toUpperCase()),
				GlobalProperties.ENV.valueOf("ALPHA"));
        ...
        launchAdminBrowser( "true", (String)data[0][4], (String)data[0][7], (String)data[0][8], (String)data[0][0], brand, "alpha", context);
	}
	...
	public void testadminwithdraw(String server) throws Exception {
		Object data[][] = TestDataProvider.getAlphaRegUsersData(GlobalMethods.getBrand(), server);
