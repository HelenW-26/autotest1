...
import newcrm.testcases.alpharegression.AlphaRegisterGoldTestCases;
...
public class AlphaWalletRegisterTestCases extends WalletRegisterTestCases {

    AlphaRegisterGoldTestCases alphaRegGoldTc = new AlphaRegisterGoldTestCases();
    ...
    public void initiEnv(String brand,String server, String branchVersion, ITestContext context) {
        ...
        regGoldTc.ibCode = GlobalMethods.getRegAffID(brand, ENV.ALPHA);
        regGoldTc.data = TestDataProvider.getAlphaRegisterUsersData(brand, server);
