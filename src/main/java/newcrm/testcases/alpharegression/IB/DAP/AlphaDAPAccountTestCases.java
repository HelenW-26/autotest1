...
public class AlphaDAPAccountTestCases extends DAPAccountTestCases {
    ...
    public void initiEnv(String brand,String server, ITestContext context) throws Exception {
        ...
        if(brand.equalsIgnoreCase(GlobalProperties.BRAND.VFX.toString())) {
            launchBrowserDAP("alpha","true", brand, (String)data[0][0], (String)data[0][3], (String)data[0][1], (String)data[0][2], (String)data[0][4], (String)data[0][8], (String)data[0][9], "True", context);
        }
    }
