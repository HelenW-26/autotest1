...
public class AlphaSUBSignalProviderTestCases extends CopyTradingTestCases {
    ...
    public void initiEnv(String brand,String server, ITestContext context) {
        ...
        Object data[][] = TestDataProvider.getAlphaCopyTradingSUBSignalPrvUserData(brand, server);
