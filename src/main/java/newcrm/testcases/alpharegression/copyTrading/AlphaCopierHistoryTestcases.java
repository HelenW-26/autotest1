...
public class AlphaCopierHistoryTestcases extends CopyTradingTestCases {
    ...
    public void initiEnv(String brand,String server, ITestContext context) {
        ...
        Object data[][] = TestDataProvider.getAlphaCopyTradingCopierMenuUserData(brand, server);
    ...
    @Test(description = testCaseDescUtils.CPCOPYTRADING_HISTORY, groups = {"CP_CopyTrading_History"})
    public void copierHistoryTest() {
        testCopierHistory(copierAccount,strategyAccount);
    }
}
