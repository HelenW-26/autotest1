...
public class AlphaSignalProviderAgentLink extends CopyTradingTestCases {
    ...
    public void initiEnv(String brand,String server, ITestContext context) {
        ...
        Object data[][] = TestDataProvider.getAlphaCopyTradingAgentLinkUserData(brand, server);
    ...
    public void signalProviderAgentLinkTest() {
        //目前只有AU有agent link,其它品牌加了之后再陆续添加
