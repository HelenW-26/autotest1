...
public class AlphaCopierDetailsTestcases extends CopyTradingTestCases {
    ...
    @Test(description = testCaseDescUtils.CPCOPYTRADING_DETAIL, groups = {"CP_CopyTrading_Detail"})
    public void copierDetailTest() {
        testCopierDetail(copierAccount,strategyAccount);
    }
}
