...
public class AlphaCopyTradingRegisterTestCases extends RegisterTestcases {
    ...
    public void testOpenCopyTradingAccount_withoutSumsub(@Optional("")String country) throws Exception {
        ...
        {
            registerNew(ibCode,"", "", GlobalProperties.PLATFORM.MTS,country,false, GlobalProperties.ACCOUNTTYPE.STANDARD_STP,GlobalProperties.CURRENCY.USD, false);
        }
        else
        {
