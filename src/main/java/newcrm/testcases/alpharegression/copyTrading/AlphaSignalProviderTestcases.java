...
public class AlphaSignalProviderTestcases extends CopyTradingTestCases {
    ...
    public void initiEnv(String brand,String server, ITestContext context) {
        ...
        Object data[][] = TestDataProvider.getAlphaCopyTradingSignalPrvUserData(brand, server);
        Object subData[][] = TestDataProvider.getAlphaCopyTradingSUBSignalPrvUserData(brand, server);
