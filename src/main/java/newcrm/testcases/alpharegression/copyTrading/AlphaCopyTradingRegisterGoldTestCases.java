...
public class AlphaCopyTradingRegisterGoldTestCases extends RegisterGoldTestcases {
    ...
    public void testOpenCopyTradingAccount_Gold_withoutSumsub(@Optional("")String country) throws Exception {
        ...
        {
            register(ibCode, "", "",GlobalProperties.PLATFORM.MTS, country, false, GlobalProperties.ACCOUNTTYPE.STANDARD_STP, GlobalProperties.CURRENCY.USD, false);
        }
        else {
