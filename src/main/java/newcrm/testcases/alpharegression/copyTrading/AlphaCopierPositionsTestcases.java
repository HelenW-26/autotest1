...
public class AlphaCopierPositionsTestcases extends CopyTradingTestCases {
    ...
    public void initiEnv(String brand,String server, ITestContext context) {
        ...
        Object data[][] = TestDataProvider.getAlphaCopyTradingCopierUserData(brand, server);
        strategyAccount = (String) data[0][4];
        copierAccount = (String) data[0][3];
        assertNotNull(data);
        launchBrowser("alpha","true",brand,(String)data[0][0],(String)data[0][5],(String)data[0][1],(String)data[0][2],"","","","True",context);
    }

    @Test(description = testCaseDescUtils.CPCOPYTRADING_POSITION, groups = {"CP_CopyTrading_Position"})
    public void copierPositionTest() {
        testCopierPositionCopyTrading(copierAccount,strategyAccount);
    }
}
