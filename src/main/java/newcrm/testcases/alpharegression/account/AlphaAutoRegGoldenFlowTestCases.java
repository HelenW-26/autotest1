...
public class AlphaAutoRegGoldenFlowTestCases extends RegisterGoldTestcases {
    ...
    @Test(description = testCaseDescUtils.CPACC_AUTO_REGISTER_GOLDEN_FLOW_MT5_WITH_SUMSUB_ALPHA, groups = {"CP_GF_Auto_Register"})
    @Parameters(value= {"Country"})
    public void testAutoRegistMT5LiveAccount_Gold(@Optional("")String country) throws Exception {
        ...
        {
            registerAuto(ibCode, "", "", PLATFORM.MT5, country, ACCOUNTTYPE.MT5_TRADING_VIEW_STP, CURRENCY.USD, true);
        } else {
