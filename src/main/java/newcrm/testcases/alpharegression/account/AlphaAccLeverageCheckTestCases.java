...
public class AlphaAccLeverageCheckTestCases extends AccountManagementTestCases {
    ...
    @Test(description = testCaseDescUtils.CPACC_MT5_LIVE_ACC_LEVERAGE_500_CHECK, groups = {"CP_Live_Acc_Leverage_Check"})
    @Parameters("Country")
    public void testMT5LiveAccountLeverage500Check(@Optional("")String country) throws Exception {
        LogUtils.info(String.format("Country: %s, Leverage: %s", country, "500"));
        liveAccountLeverageCheck(GlobalProperties.PLATFORM.MT5, "500");
    }
