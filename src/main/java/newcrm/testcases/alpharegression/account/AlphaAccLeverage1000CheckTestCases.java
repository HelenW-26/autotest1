...
public class AlphaAccLeverage1000CheckTestCases extends AccountManagementTestCases {
    ...
    @Test(description = testCaseDescUtils.CPACC_MT5_LIVE_ACC_LEVERAGE_1000_CHECK, groups = {"CP_Live_Acc_Leverage_Check"})
    @Parameters("Country")
    public void testMT5LiveAccountLeverage1000Check(@Optional("")String country) throws Exception {
        LogUtils.info(String.format("Country: %s, Leverage: %s", country, "1000"));
        liveAccountLeverageCheck(GlobalProperties.PLATFORM.MT5, "1000");
    }
