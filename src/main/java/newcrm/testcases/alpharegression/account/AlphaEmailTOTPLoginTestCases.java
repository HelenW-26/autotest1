...
public class AlphaEmailTOTPLoginTestCases extends AccountLoginTestCases {
...
//        adminPaymentAPI = new AdminAPIPayment((String) data[0][4], GlobalProperties.REGULATOR.valueOf((String) data[0][0]), (String) data[0][7], (String) data[0][8], GlobalProperties.BRAND.valueOf(brand.toUpperCase()), GlobalProperties.ENV.valueOf("ALPHA"));
    ...
    @Test(description = testCaseDescUtils.CPACCOUNT_EMAIL_TOTP_LOGIN, groups= {"CP_Email_TOTP_Login"})
    public void testAccountEmailLoginTOTP() throws Exception {
        accountEmailLoginTOTP();
    }
