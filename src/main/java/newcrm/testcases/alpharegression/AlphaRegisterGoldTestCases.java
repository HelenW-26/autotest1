...
public class AlphaRegisterGoldTestCases extends RegisterGoldTestcases {
    ...
    @Override
    @Test(description = testCaseDescUtils.CPACC_REGISTER_GOLDEN_FLOW_MT5_WITH_SUMSUB_ALPHA, groups = {"CP_GoldenFlow_AU_Only"})
    ...
    @Test(description = testCaseDescUtils.CPACC_REGISTER_GOLDEN_FLOW_MT5_ALPHA, groups = {"CP_GoldenFlow_AU_Only"})
    @Parameters(value= {"Country"})
