...
public class UATDemoRegGoldenFlowTestCases extends RegisterGoldTestcases {
    ...
    @Test(description = testCaseDescUtils.CPACC_REGISTER_DEMO_GOLDEN_FLOW_MT5_WITH_SUMSUB, groups = {"CP_GF_Demo_Register"})
