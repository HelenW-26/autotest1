...
public class UATAutoRegGoldenFlowTestCases extends RegisterGoldTestcases {
    ...
    @Test(description = testCaseDescUtils.CPACC_AUTO_REGISTER_GOLDEN_FLOW_MT5_WITH_SUMSUB, groups = {"CP_GF_Auto_Register"})
