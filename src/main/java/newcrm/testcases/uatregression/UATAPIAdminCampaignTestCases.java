...
public class UATAPIAdminCampaignTestCases extends AdminAPICampaignTestCases {
    ...
    public void initEnv(String brand, String server, ITestContext context) {
        ...
        Object[][] data = UATTestDataProvider.getUATRegUsersData(this.brand, server);
        adminApiCampaign = new AdminAPICampaign((String) data[0][4], GlobalProperties.REGULATOR.valueOf((String)data[0][0]),(String)data[0][7],(String)data[0][8],GlobalProperties.BRAND.valueOf(this.brand.toUpperCase()), GlobalProperties.ENV.valueOf("UAT"));
    }
