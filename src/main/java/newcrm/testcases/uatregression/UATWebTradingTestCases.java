...
import static newcrm.utils.testCaseDescUtils.CPWEBTRADING_PENDINGORDER_STOP;
import static newcrm.utils.testCaseDescUtils.CPWEBTRADING_POSITION_CLOSE_ALL;
import static org.testng.Assert.assertNotNull;

public class UATWebTradingTestCases extends WebTradingTestCases {
    ...
    public void initiEnv(String brand,String server, ITestContext context) {
        ...
        Object data[][] = UATTestDataProvider.getUATWebTradingUserData(brand, server);
        webTradingAccount = (String) data[0][3];
        assertNotNull(data);

        webTradingBrands = Arrays.asList(GlobalProperties.BRAND.VFX.toString());
        if (webTradingBrands.contains(this.brand.toUpperCase())) {
            ...
            launchBrowser("uat", "true", this.brand, (String) data[0][0], (String) data[0][4], (String) data[0][1], (String) data[0][2], "", "", "", "True", context);
        }
    }
