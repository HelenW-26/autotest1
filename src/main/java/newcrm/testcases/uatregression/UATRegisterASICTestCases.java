...
public class UATRegisterASICTestCases extends RegisterTestcases {
    ...
    public void initiEnv(String brand, String server, String branchVersion, ITestContext context) {
        ...
        launchBrowser("uat","true",brand,(String)data[0][0],(String)data[0][3],(String)data[0][1],(String)data[0][2],(String)data[0][4],(String)data[0][7],(String)data[0][8],"True",context);
    }

    @Test(description = testCaseDescUtils.CPACC_REGISTER_ASIC_MT5, groups= {"CP_Register_ASIC"})
    ...
    public void testRegisterASIC(@Optional("")String Country)  {
        ...
        List<String> withoutCheck = Arrays.asList(GlobalProperties.BRAND.PUG.toString());
    ...
    @Override
    @Test(priority = 0, description = testCaseDescUtils.CPACC_REGISTER_ASIC_MT5)
