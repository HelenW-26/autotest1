...
public class UATCopyTradingWithdrawTestCases extends WithdrawTestCases {
    @Override
    ...
    public void initiEnv(String brand,String server, ITestContext context) {
        ...
        adminPaymentAPI = new AdminAPIPayment((String) data[0][5], GlobalProperties.REGULATOR.valueOf((String)data[0][0]),(String)data[0][8],(String)data[0][9],GlobalProperties.BRAND.valueOf(brand.toUpperCase()), GlobalProperties.ENV.valueOf("UAT"));;
        adminPaymentAPI.apiDisableLoginWithdrawal2FA();

        launchBrowser("uat","true",brand,(String)data[0][0],(String)data[0][4],(String)data[0][1],(String)data[0][2],"","","","True",context);
