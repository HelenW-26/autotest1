...
public class UATCopyTradingTestCases extends CopyTradingTestCases {
    ...
    public void initiEnv(String brand,String server, ITestContext context) {
        ...
        Object data[][] = UATTestDataProvider.getUATCopyTradingUserData(brand, server);
        copierAccount = (String) data[0][3];
        signalProvAccount = (String) data[0][4];
        assertNotNull(data);

        copyTradingBrands = Arrays.asList("vfx","pug");
        ...
        if (copyTradingBrands.contains(this.brand.toLowerCase())) {
            ...
            AdminAPIUserAccount adminAPIUserAccount = new AdminAPIUserAccount((String) data[0][6], GlobalProperties.REGULATOR.valueOf((String) data[0][0]), (String) data[0][7], (String) data[0][8], GlobalProperties.BRAND.valueOf(this.brand), GlobalProperties.ENV.valueOf("UAT"));
            ...
            launchBrowser("uat", "true", this.brand, (String) data[0][0], (String) data[0][5], (String) data[0][1], (String) data[0][2], "", "", "", "True", context);
        }
    }
