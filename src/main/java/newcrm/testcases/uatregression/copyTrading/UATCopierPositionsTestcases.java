...
public class UATCopierPositionsTestcases extends CopyTradingTestCases {
    ...
    public void initiEnv(String brand,String server, ITestContext context) {
        ...
        Object data[][] = UATTestDataProvider.getUATCopyTradingCopierUserData(brand, server);
        strategyAccount = (String) data[0][4];
        copierAccount = (String) data[0][3];
        assertNotNull(data);
        launchBrowser("uat","false",brand,(String)data[0][0],(String)data[0][5],(String)data[0][1],(String)data[0][2],"","","","True",context);
    }
