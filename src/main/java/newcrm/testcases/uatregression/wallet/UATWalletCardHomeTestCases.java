...
import newcrm.testcases.cptestcases.wallet.WalletCardHomeTestCases;
 ...
 * @Description
 **/
public class UATWalletCardHomeTestCases extends WalletCardHomeTestCases {
    @Override
    ...
    public void initiEnv(String brand,String server, ITestContext context) {
        ...
        //目前是在alpaca调试，该环境已上理财，但UAT环境理财发卡流程走不通，故暂时用alpha环境测试
