package newcrm.testcases.uatregression.support;

import newcrm.global.GlobalMethods;
import newcrm.testcases.UATTestDataProvider;
import newcrm.testcases.cptestcases.support.SupportTestCases;
...
public class UATSupportTestCases extends SupportTestCases {
    ...
    @Test(description = testCaseDescUtils.CPSUPPORT_CREATE_TICKET, groups= {"CP_Support_Ticket"})
    public void testCreateSupportTicket() throws Exception {
        createSupportTicket();
    }
