...
public class UATWithdrawLimitTestCases extends WithdrawLimitTestCases {
    ...
    public void initiEnv(String brand,String server, ITestContext context) throws Exception{
        ...
        data = UATTestDataProvider.getUATWithdrawLimitUsersData(brand, server);
        assertNotNull(data);

        adminPaymentAPI = new AdminAPIPayment((String) data[0][4], REGULATOR.valueOf((String)data[0][0]),(String)data[0][7],(String)data[0][8], BRAND.valueOf(brand.toUpperCase()), ENV.valueOf("UAT"));
    ...
    public void judgeMsgEnable2fa(){
        try {
            ...
            DBUtils.updateSafeValidate("UAT", GlobalMethods.getBrand(), (String)data[0][0],userId());
    ...
    public void limitWithResetPwd(){
        ...
        if("UM".equalsIgnoreCase(brand)){
            ...
            method = DEPOSITMETHOD.CRYPTOBTC;
        ...
        limitWithResetPwd(data,method,ruleId,"UAT");
    }
...
//            method = DEPOSITMETHOD.MALAYINSTANT;
    ...
    public void limitWithModifyEmail(String brand){
        ...
        try {
            DBUtils.updateSafeValidate("UAT", GlobalMethods.getBrand(), (String)data[0][0],userId());
            adminPaymentAPI.disable2FA(userId());
            limitWithModifyEmail(data,brand,method,ruleId,"UAT");
        } catch (Exception e) {
            fail();
            LogUtils.info("Account detected with remote login activity; enable 2fa failed. ");
        }
