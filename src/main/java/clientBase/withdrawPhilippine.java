...
public class withdrawPhilippine extends withdrawGeneral{
	...
	public withdrawPhilippine(WebDriver driver, String Brand)
	{
	...
	public WebElement getBankAccountSelelctEle()
	{
		...
		{
			case "vt":
			    //VT doesn't support Philippine Bank Transfer
				//tmpEle = driver.findElement(By.xpath("//div[@data-testid='numberSelection']//input"));
				break;
			case "fsa":
			case "svg":
				tmpEle = driver.findElement(By.xpath("//div[@id='PhilipinessForm']/form/ul[1]/li[1]//input"));
				break;
	...
	public WebElement getBankNameEle()
	{
		...
		{
			case "vt":
				//VT doesn't support Philippines Bank Transfer
				break;
				
			case "fsa":
			case "svg":
				tmpEle = driver.findElements(By.xpath("//div[@id='PhilipinessForm']/form/div[1]//input")).get(0);
				break;
	...
	public WebElement getBankAddrEle()
	{
		...
		switch(Brand.toLowerCase())
		{
			...
			case "fsa":
			case "svg":
				tmpEle = driver.findElements(By.xpath("//div[@id='PhilipinessForm']/form/div[1]//input")).get(1);
				break;
	...
	public WebElement getBankBenefiEle()
	{
		...
		switch(Brand.toLowerCase())
		{
			...
			case "fsa":
			case "svg":
				tmpEle = driver.findElements(By.xpath("//div[@id='PhilipinessForm']/form/div[1]//input")).get(2);
				break;
	...
	public WebElement getBankAcctNoEle()
	{
		...
		switch(Brand.toLowerCase())
		{
			...
			case "fsa":
			case "svg":
				tmpEle = driver.findElements(By.xpath("//div[@id='PhilipinessForm']/form/div[1]//input")).get(3);
				break;
	...
	public WebElement getNotesEle()
	{
		...
		switch(Brand.toLowerCase())
		{
			...
			case "fsa":
			case "svg":
				tmpEle = driver.findElements(By.xpath("//div[@id='PhilipinessForm']/form/div[1]//input")).get(4);
				break;
